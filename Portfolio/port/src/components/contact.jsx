...
function Contact() {
  return (
    <div>
                 <h1 className="flex justify-center font-bold text-4xl mb-6">Contact</h1>
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-12 mx-auto">
        <div>
            ...
            <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Let's have a friendly chat!</h1>

            <p class="mt-3 text-gray-500 dark:text-gray-400"> I love to hear from you. Please fill out this form or shoot a email.</p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">aswinsee796@gmail.com</p>
                </div>
                ...
                <div>
                    ...
                    {/* <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Our friendly team is here to help.</p> */}
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">Coimbatore,Tamil Nadu</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">(+91)7010866027</p>
                </div>
            </div>
